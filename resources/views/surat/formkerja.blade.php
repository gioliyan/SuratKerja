                ...
                <div class="card-body">
                    ...
                    {{ csrf_field() }}
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_pg1" placeholder="Nama Instansi">
                        </div>
                        <div class="form-group mb-3">
                            <label for="isisurat" class="form-label">NIP Pegawai 1</label>
                            <input type="text" class="form-control" name="nip_pg1" placeholder="Nama Instansi">
                        </div>
                        <div class="form-group mb-3">
                            <label for="isisurat" class="form-label">Pangkat Pegawai 1</label>
                            <input type="text" class="form-control" name="pangkat_pg1" placeholder="Nama Instansi">
                        </div>
                        <div class="form-group">
                            <label for="nomorsurat">Jabatan Pegawai 1</label>
                            <input type="text" class="form-control" name="jabatan_pg1" placeholder="Nama Instansi">
                        </div>
                        <div class="form-group mb-3">
